...
import { IncidentType } from "@/app/(protected)/service-provider/tasks/data/schema";
...
export function CreateIncidentForm({ clientId }: Props) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      // TODO: Mejorar los componentes para que la actualizacion de datos sea optima y no use un hard refresh
